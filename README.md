...
```mermaid
pie title Коммиты по авторам
    "НЕ СТАРЫЙ БОГ (69)" : 69
    "satorudio (14)" : 14
    "Арсений (7)" : 7
    "СТАРЫЙ БОГ (4)" : 4
    "RKeng Audit (1)" : 1
    "ЛЖЕСТАРЫЙ БОГ НЕНАСТОЯЩИЙ (1)" : 1
```

| Автор | Коммитов | Титул |
|---|---|---|
| НЕ СТАРЫЙ БОГ | 69 | Главный по фиксам. Решил кризис идентичности через коммит. |
| satorudio | 14 | Задал главный вопрос эпохи: "ДА КТО ТАКОЙ СТАРЫЙ БОГ" |
| Арсений | 7 | Единственный кто реально чинил Jolt ABI руками |
| СТАРЫЙ БОГ | 4 | Написал README 4 раза. Исчез. |
| RKeng Audit | 1 | Пришёл, почистил мёртвый код, ушёл |
| ЛЖЕСТАРЫЙ БОГ(НЕНАСТОЯЩИЙ) | 1 | Написал доки. Не старый бог. |
